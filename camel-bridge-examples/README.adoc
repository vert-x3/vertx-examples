...
----
java -jar target/camel-bridge-examples-5.2.0.jar io.vertx.example.camel.feed.FeedExample
----
...
----
java -jar target/camel-bridge-examples-5.2.0.jar io.vertx.example.camel.rmi.RMIExample
----
