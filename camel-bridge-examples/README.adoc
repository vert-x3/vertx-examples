...
----
java -jar target/camel-bridge-examples-4.1.0.jar run io.vertx.example.camel.feed.FeedExample
----
...
----
java -jar target/camel-bridge-examples-4.1.0.jar run io.vertx.example.camel.rmi.RMIExample
----
