...
----
java -jar target/camel-bridge-examples-3.4.2-SNAPSHOT.jar run io.vertx.example.camel.feed.FeedExample
----
...
----
java -jar target/camel-bridge-examples-3.4.2-SNAPSHOT.jar run io.vertx.example.camel.rmi.RMIExample
----
