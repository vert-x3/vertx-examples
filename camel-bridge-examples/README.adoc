...
----
java -jar target/camel-bridge-examples-3.6.1.jar run io.vertx.example.camel.feed.FeedExample
----
...
----
java -jar target/camel-bridge-examples-3.6.1.jar run io.vertx.example.camel.rmi.RMIExample
----
