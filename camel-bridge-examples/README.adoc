...
----
java -jar target/camel-bridge-examples-4.0.0.Beta2.jar run io.vertx.example.camel.feed.FeedExample
----
...
----
java -jar target/camel-bridge-examples-4.0.0.Beta2.jar run io.vertx.example.camel.rmi.RMIExample
----
