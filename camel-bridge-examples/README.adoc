...
----
java -jar target/camel-bridge-examples-3.8.5.jar run io.vertx.example.camel.feed.FeedExample
----
...
----
java -jar target/camel-bridge-examples-3.8.5.jar run io.vertx.example.camel.rmi.RMIExample
----
