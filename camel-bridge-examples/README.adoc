...
----
java -jar target/camel-bridge-examples-5.0.0.CR7.jar run io.vertx.example.camel.feed.FeedExample
----
...
----
java -jar target/camel-bridge-examples-5.0.0.CR7.jar run io.vertx.example.camel.rmi.RMIExample
----
