...
----
java -jar target/camel-bridge-examples-3.6.0.jar run io.vertx.example.camel.feed.FeedExample
----
...
----
java -jar target/camel-bridge-examples-3.6.0.jar run io.vertx.example.camel.rmi.RMIExample
----
