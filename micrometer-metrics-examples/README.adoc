...
[source,bash]
----
java -cp target/micrometer-metrics-examples-4.0.0-milestone5-fat.jar io.vertx.example.micrometer.prometheus.Main
----
...
[source,bash]
----
java -cp target/micrometer-metrics-examples-4.0.0-milestone5-fat.jar io.vertx.example.micrometer.prometheus.MainWithBoundPrometheus
----
...
[source,bash]
----
java -cp target/micrometer-metrics-examples-4.0.0-milestone5-fat.jar io.vertx.example.micrometer.influxdb.Main
----
...
[source,bash]
----
java -cp target/micrometer-metrics-examples-4.0.0-milestone5-fat.jar io.vertx.example.micrometer.jmx.Main
----
