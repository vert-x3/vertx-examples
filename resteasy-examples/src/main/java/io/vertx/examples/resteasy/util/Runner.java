package io.vertx.examples.resteasy.util;
...
public class Runner {
  ...
  private static final String RESTEASY_EXAMPLES_DIR = "resteasy-examples";
  private static final String RESTEASY_EXAMPLES_JAVA_DIR = RESTEASY_EXAMPLES_DIR + "/src/main/java/";

  public static void runExample(Class clazz) {
    runExample(RESTEASY_EXAMPLES_JAVA_DIR, clazz, new VertxOptions(), null, false);
  }
