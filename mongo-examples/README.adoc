...
----
# java
vertx run io.vertx.examples.mongo.MongoClientVerticle -cp target/mongo-examples-3.5.3.jar -conf my-mongo-config.json

# javascript
vertx run src/main/js/io/vertx/examples/mongo/mongo_client_verticle.js  -cp target/mongo-examples-3.5.3.jar -conf my-mongo-config.json

# groovy
vertx run src/main/groovy/io/vertx/examples/mongo/mongo_client_verticle.groovy   -cp target/mongo-examples-3.5.3.jar -conf my-mongo-config.json

# ruby
vertx run src/main/ruby/io/vertx/examples/mongo/mongo_client_verticle.rb   -cp target/mongo-examples-3.5.3.jar -conf my-mongo-config.json
----
