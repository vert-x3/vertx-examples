...
To run the fat jar:
    ...
    java -jar target/http2-fatjar-4.0.0-milestone5.jar
...
To run the fat jar:
    ...
    java -jar build/libs/http2-fatjar-4.0.0-milestone5-all.jar
...
To run the fat jar:
    ...
    java -jar target/ruby-fatjar-4.0.0-milestone5.jar.jar
...
To run the fat jar:
    ...
    java -jar build/libs/ruby-fatjar-4.0.0-milestone5-all.jar
