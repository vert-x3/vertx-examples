...
To run the fat jar:
    ...
    java -jar target/http2-fatjar-3.7.0.jar
...
To run the fat jar:
    ...
    java -jar build/libs/http2-fatjar-3.7.0-all.jar
...
To run the fat jar:
    ...
    java -jar target/ruby-fatjar-3.7.0.jar.jar
...
To run the fat jar:
    ...
    java -jar build/libs/ruby-fatjar-3.7.0-all.jar
