...
link:src/main/js/io/vertx/example/core/net/echossl/echoserver.js[JavaScript echo ssl server]
link:src/main/js/io/vertx/example/core/net/echossl/echoclient.js[JavaScript echo ssl client]
