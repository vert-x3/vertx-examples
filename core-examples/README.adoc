...
link:src/main/java/io/vertx/example/core/net/advanced/Server.java[Java advanced echo server]
link:src/main/java/io/vertx/example/core/net/advanced/Client.java[Java advanced echo client]
