package io.vertx.example.internal;
...
public class Translator {
  ...
  public static void main(String[] args) throws Exception {
    ...
    String[] inputFiles = new String[] {
      "core-examples/src/main/java/io/vertx/example/core/echo/EchoServer.java",
      "core-examples/src/main/java/io/vertx/example/core/echo/EchoClient.java"
    };

    String[] outputFiles = new String[] {
      "core-examples/src/main/js/echo/echo_server.js",
      "core-examples/src/main/js/echo/echo_client.js",
    };
