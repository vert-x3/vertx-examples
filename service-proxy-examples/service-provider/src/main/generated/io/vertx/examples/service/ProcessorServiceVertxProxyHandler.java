...
public class ProcessorServiceVertxProxyHandler extends ProxyHandler {
  ...
  public ProcessorServiceVertxProxyHandler(Vertx vertx, ProcessorService service, String address) {
  ...
  public ProcessorServiceVertxProxyHandler(Vertx vertx, ProcessorService service, String address, boolean topLevel, long timeoutSeconds) {
    this.vertx = vertx;
