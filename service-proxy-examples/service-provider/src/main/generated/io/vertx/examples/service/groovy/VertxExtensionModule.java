...
public class VertxExtensionModule extends ExtensionModule {
  private static final String extensionClasses = "io.vertx.examples.service.groovy.ProcessorService_GroovyExtension";
  private static final String staticExtensionClasses = "";
  private final ExtensionModule delegate;  public VertxExtensionModule() {
    super("io.vertx.examples.service", "3.5.0");
    Properties props = new Properties();
    props.put("moduleName", "io.vertx.examples.service");
