...
```
   ...
   24|Active     |    1|osgi-examples (3.3.2.SNAPSHOT)|3.3.2.SNAPSHOT <--- this project
   25|Active     |    1|vertx-auth-common (3.3.2.SNAPSHOT)|3.3.2.SNAPSHOT
   26|Active     |    1|Vert.x Core (3.3.2.SNAPSHOT)|3.3.2.SNAPSHOT
   27|Active     |    1|vertx-jdbc-client (3.3.2.SNAPSHOT)|3.3.2.SNAPSHOT
   28|Active     |    1|vertx-sql-common (3.3.2.SNAPSHOT)|3.3.2.SNAPSHOT
   29|Active     |    1|vertx-web (3.3.2.SNAPSHOT)|3.3.2.SNAPSHOT
```
