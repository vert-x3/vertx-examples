...
```
[13] - io.vertx.core - 3.4.0-SNAPSHOT
...
[29] - vertx-web - 3.4.0-SNAPSHOT
[30] - vertx-auth-common - 3.4.0-SNAPSHOT
[31] - vertx-jdbc-client - 3.4.0-SNAPSHOT
[32] - vertx-sql-common - 3.4.0-SNAPSHOT
[33] - com.zaxxer.HikariCP - 2.4.6
[34] - org.hsqldb.hsqldb - 2.3.4
[35] - org.apache.felix.ipojo - 1.12.1
[36] - org.apache.commons.io - 2.5.0
[37] - io.vertx.osgi-examples - 3.4.0-SNAPSHOT <--- current project
```
