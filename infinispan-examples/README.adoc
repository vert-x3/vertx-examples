...
----
mvn clean package
java -jar target/infinispan-examples-3.7.0-fat.jar run io.vertx.example.infinispan.StatsProducerApp -cluster
java -jar target/infinispan-examples-3.7.0-fat.jar run io.vertx.example.infinispan.StatsConsumerApp -cluster
java -jar target/infinispan-examples-3.7.0-fat.jar run io.vertx.example.infinispan.DisplayStatsApp -cluster
----
