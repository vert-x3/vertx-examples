 ...
 * @example
   <doc:example>
     <doc:source>
       <span ng-non-bindable>{{1288323.2.106 | date:'medium'}}</span>:
           {{1288323.2.106 | date:'medium'}}<br>
       <span ng-non-bindable>{{1288323.2.106 | date:'yyyy-MM-dd HH:mm:ss Z'}}</span>:
          {{1288323.2.106 | date:'yyyy-MM-dd HH:mm:ss Z'}}<br>
       <span ng-non-bindable>{{1288323.2.106 | date:'MM/dd/yyyy @ h:mma'}}</span>:
          {{'1288323.2.106' | date:'MM/dd/yyyy @ h:mma'}}<br>
     </doc:source>
     <doc:scenario>
       it('should format date', function() {
         expect(binding("1288323.2.106 | date:'medium'")).
            toMatch(/Oct 2\d, 2010 \d{1,2}:\d{2}:\d{2} (AM|PM)/);
         expect(binding("1288323.2.106 | date:'yyyy-MM-dd HH:mm:ss Z'")).
            toMatch(/2010\-10\-2\d \d{2}:\d{2}:\d{2} \-?\d{4}/);
         expect(binding("'1288323.2.106' | date:'MM/dd/yyyy @ h:mma'")).
