...
link:src/main/java/io/vertx/example/reactivex/web/client/simple/Client.java[RxJava simple web client]
...
link:src/main/java/io/vertx/example/reactivex/web/client/zip/Client.java[RxJava zip web client]

=== Unmarshalling

The web client json response is unmarshalled to a Java object using the web client unmarshalling features.

link:src/main/java/io/vertx/example/reactivex/web/client/unmarshalling/Client.java[RxJava unmarshalling web client]
...
link:src/main/java/io/vertx/example/reactivex/web/realtime/Server.java[RxJava real-time web]
...
link:src/main/java/io/vertx/example/reactivex/http/client/simple/Server.java[RxJava simple HTTP server]

The client uses an `Observable<HttpClientRequest` and applies `flatMap` to get a `Observable<Buffer>`

link:src/main/java/io/vertx/example/reactivex/http/client/simple/Client.java[RxJava simple HTTP client]
...
link:src/main/java/io/vertx/example/reactivex/http/client/reduce/Client.java[RxJava reduce HTTP client]
...
link:src/main/java/io/vertx/example/reactivex/http/client/zip/Client.java[RxJava zip HTTP client]
...
link:src/main/java/io/vertx/example/reactivex/http/client/unmarshalling/Client.java[RxJava unmarshalling HTTP client]
...
link:src/main/java/io/vertx/example/reactivex/eventbus/pubsub/Receiver.java[RxJava event bus pubsub receiver]
link:src/main/java/io/vertx/example/reactivex/eventbus/pubsub/Sender.java[RxJava event bus pubsub sender]

=== Ping / Pong

An example of sending, receiving and replying to messages using the Rx api.

link:src/main/java/io/vertx/example/reactivex/eventbus/pingpong/PingPong.java[RxJava simple ping-pong ]
...
link:src/main/java/io/vertx/example/reactivex/eventbus/zipreplies/Receiver.java[RxJava zipreplies eventbus receiver]
link:src/main/java/io/vertx/example/reactivex/eventbus/zipreplies/Sender.java[RxJava zipreplies eventbus sender]
...
link:src/main/java/io/vertx/example/reactivex/database/jdbc/Client.java[RxJava jdbc client]
...
link:src/main/java/io/vertx/example/reactivex/database/mongo/Client.java[RxJava Mongo client]
