...
- link:src/main/java/io/vertx/example/grpc/eventbus/Client.java[Event bus client example]
- link:src/main/java/io/vertx/example/grpc/eventbus/Server.java[Event bus server example]
