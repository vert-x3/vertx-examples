...
- link:src/main/java/io/vertx/example/grpc/eventbus/StreamingClient.java[Event bus streaming client example]
- link:src/main/java/io/vertx/example/grpc/eventbus/StreamingServer.java[Event bus streaming server example]
