...
java -jar build/libs/gradle-verticle-3.2.1-fat.jar -instances 8

You can also enable clustering and ha at the command line, e.g.

java -jar build/libs/gradle-verticle-3.2.1-fat.jar -cluster

java -jar build/libs/gradle-verticle-3.2.1-fat.jar -ha
