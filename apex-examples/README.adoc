...
The link:src/main/java/io/vertx/example/apex/chat/Server.java[Java real-time chat example]

The link:src/main/java/io/vertx/example/apex/chat/webroot/index.html[index.html] file
