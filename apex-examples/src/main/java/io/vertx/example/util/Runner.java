...
public class Runner {
  ...
  private static final String APEX_EXAMPLES_RUBY_DIR = APEX_EXAMPLES_DIR + "/src/main/rb/";
  ...
  static class RubyAuthRunner {
    public static void main(String[] args) {
      Runner.runRubyExample("io/vertx/example/apex/auth/server.rb");
    }
  }

  static class RubyHelloWorldRunner {
    public static void main(String[] args) {
      Runner.runRubyExample("io/vertx/example/apex/helloworld/server.rb");
    }
  }

  static class RubyChatRunner {
    public static void main(String[] args) { Runner.runRubyExample("io/vertx/example/apex/chat/server.rb");
    }
  }

  static class RubyRealtimeRunner {
    public static void main(String[] args) {
      Runner.runRubyExample("io/vertx/example/apex/realtime/server.rb");
    }
  }

  static class RubySessionsRunner {
    public static void main(String[] args) {
      Runner.runRubyExample("io/vertx/example/apex/sessions/server.rb");
    }
  }

  static class RubyTemplatingRunner {
    public static void main(String[] args) {
      Runner.runRubyExample("io/vertx/example/apex/templating/server.rb");
    }
  }
}
