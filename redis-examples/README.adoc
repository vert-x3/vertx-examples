...
* JavaScript: link:src/main/js/io/vertx/examples/redis/RedisClientVerticle.js[RedisClientVerticle.js]
* Groovy: link:src/main/groovy/io/vertx/examples/redis/RedisClientVerticle.groovy[RedisClientVerticle.groovy]
* Ruby: link:src/main/rb/io/vertx/examples/redis/RedisClientVerticle.rb[RedisClientVerticle.rb]
