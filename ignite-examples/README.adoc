...
----
mvn clean package
java -jar target/ignite-examples-3.9.0-fat.jar run io.vertx.example.ignite.ProducerApp -cluster
java -jar target/ignite-examples-3.9.0-fat.jar run io.vertx.example.ignite.ConsumerApp -cluster
----
