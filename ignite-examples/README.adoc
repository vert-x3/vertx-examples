...
----
mvn clean package
java -jar target/ignite-examples-3.3.0.CR1-fat.jar run io.vertx.example.ignite.ProducerApp -cluster
java -jar target/ignite-examples-3.3.0.CR1-fat.jar run io.vertx.example.ignite.ConsumerApp -cluster
----