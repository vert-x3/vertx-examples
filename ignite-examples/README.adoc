...
----
mvn clean package
java -jar target/ignite-examples-3.3.2-fat.jar run io.vertx.example.ignite.ProducerApp -cluster
java -jar target/ignite-examples-3.3.2-fat.jar run io.vertx.example.ignite.ConsumerApp -cluster
----