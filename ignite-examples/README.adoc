...
----
mvn clean package
java -jar target/ignite-examples-3.8.5-fat.jar run io.vertx.example.ignite.ProducerApp -cluster
java -jar target/ignite-examples-3.8.5-fat.jar run io.vertx.example.ignite.ConsumerApp -cluster
----
