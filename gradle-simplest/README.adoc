...
This project shows a very simple hello world Vert.x project using Gradle, which has a simple HTTP server which
...
You may also run the fat jar as a standalone runnable jar:
    ...
    java -jar build/libs/gradle-simplest-fat.jar
